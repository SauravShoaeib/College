...
Assignment: Lab 10D
Function: Write a function to your program that should produce and return a new TimeSlot for the movie nextMovie, scheduled immediately after the time slot ts.
Date: 04/11/19
Instructor: Panda
...
int main() 
{
  ...
  printTimeSlot(scheduleAfter(t, m));
}